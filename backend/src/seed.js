...
async function seed() {
  try {
    ...
    await DepositAddress.deleteMany({});
    const depositAddresses = await DepositAddress.insertMany(DEPOSIT_ADDRESSES);
    console.log(`Seeded ${depositAddresses.length} deposit addresses`);
