        ...
        <div className="flex items-center justify-between px-4 h-full max-w-2xl mx-auto lg:max-w-6xl">
          ...
          >
            <svg viewBox="0 0 46 44" width="36" height="36" xmlns="http://www.w3.org/2000/svg">
              ...
              <path fill="#E7FAAD" d="M20.931,37.742c-8.029,0-14.561-7.24-14.561-16.137c0-8.898,6.531-16.138,14.561-16.138h23.884V0H20.931C9.888,0,0.903,9.692,0.903,21.605c0,11.913,8.984,21.604,20.028,21.604h23.884v-5.467H20.931z"/>
            </svg>
          </button>
          ...
          <div className="flex-1 mx-4 flex items-center gap-3">
            {/* CEX.IO full logo */}
            <div className="hidden xs:flex items-center flex-shrink-0">
              <svg viewBox="0 0 167 44" height="28" xmlns="http://www.w3.org/2000/svg">
                <polygon fill="#0AE0D0" points="44.359,14.556 44.359,9.089 35.868,9.089 41.334,14.556"/>
                <polygon fill="#0AE0D0" points="35.551,34.119 44.359,34.119 44.359,28.652 41.018,28.652"/>
                <path fill="#0AE0D0" d="M34.198,28.652H22.625c-3.436,0-6.232-3.161-6.232-7.047c0-3.887,2.796-7.049,6.232-7.049h11.89l-5.467-5.467h-6.422c-6.451,0-11.699,5.615-11.699,12.516c0,6.9,5.248,12.514,11.699,12.514h6.181l-0.037-0.035L34.198,28.652z"/>
                <path fill="#0AE0D0" d="M38.689,18.73l-15.78,0.141c-1.509,0.014-2.722,1.248-2.709,2.758c0.014,1.501,1.234,2.709,2.733,2.709c0.008,0,0.017,0,0.025,0l15.695-0.141l2.751-2.751L38.689,18.73z"/>
                <path fill="#E7FAAD" d="M20.931,37.742c-8.029,0-14.561-7.24-14.561-16.137c0-8.898,6.531-16.138,14.561-16.138h23.884V0H20.931C9.888,0,0.903,9.692,0.903,21.605c0,11.913,8.984,21.604,20.028,21.604h23.884v-5.467H20.931z"/>
                <path fill="#FFFFFF" d="M78.135,30.796c-2.637,2.639-6.142,3.956-9.608,3.956c-8.892,0-13.526-6.216-13.564-13.337c-0.075-7.046,4.521-13.64,13.564-13.64c3.466,0,6.971,1.319,9.608,3.956l-1.394,1.206c-2.261-2.261-5.237-3.353-8.214-3.353c-7.686,0-11.642,5.425-11.605,11.755c0.076,6.179,3.994,11.529,11.605,11.529c2.977,0,5.991-1.13,8.251-3.353L78.135,30.796z"/>
                <path fill="#FFFFFF" d="M83.694,20.247h15.448v1.847H83.694v10.398h16.653v1.96h-18.65V8.077h18.199v1.921H83.694V20.247z"/>
                <path fill="#FFFFFF" d="M122.503,8.115h2.186v0.038l-8.969,12.772l9.684,13.49v0.037h-2.412l-8.514-12.059l-8.516,12.059h-2.412v-0.037l9.684-13.49l-8.967-12.772V8.115h2.223l7.988,11.266L122.503,8.115z"/>
                <path fill="#E7FAAD" d="M133.544,34.452V8.077h1.996v26.375H133.544z"/>
                <path fill="#E7FAAD" d="M166.097,21.302c-0.037,6.932-4.445,13.602-13.301,13.602c-8.854,0-13.299-6.707-13.299-13.678c0-7.083,4.406-13.564,13.299-13.564S166.134,14.181,166.097,21.302z M141.493,21.264c0.037,5.953,3.805,11.756,11.303,11.756c7.535,0,11.342-5.804,11.342-11.756c0-6.104-3.768-11.718-11.342-11.718C145.224,9.546,141.456,15.047,141.493,21.264z"/>
