...
export default function Wallet() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="overflow-hidden rounded-[34px] bg-[linear-gradient(135deg,#0b2026_0%,#11454f_48%,#1b6d71_100%)] px-6 py-7 text-white shadow-[0_30px_90px_rgba(8,32,38,0.28)] md:px-8 md:py-8">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-3 max-w-xl text-sm leading-6 text-white/68 md:text-base">
              Your portfolio, recharge flow and referral earnings now use the same exchange-style system as the public site.
            </p>
          </div>
